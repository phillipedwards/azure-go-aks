...
import (
	...
	containerservice "github.com/pulumi/pulumi-azure-native/sdk/go/azure/containerservice/v20220102preview"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		_, err = containerservice.NewAgentPool(ctx, "ask-pool", &containerservice.AgentPoolArgs{
			AgentPoolName:     pulumi.String("agentpool"),
			Mode:              pulumi.String("System"),
			OsDiskSizeGB:      pulumi.Int(30),
			Count:             pulumi.Int(2),
			VmSize:            pulumi.String("Standard_DS2_V2"),
			OsType:            pulumi.String("Linux"),
			MessageOfTheDay:   pulumi.String("some-message-here"),
			ResourceGroupName: resourceGroup.Name,
